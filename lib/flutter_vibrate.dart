...
class Vibrate {
  static const MethodChannel _channel = MethodChannel('flutter_vibrate');
  static const Duration _defaultVibrationDuration =
  ...
  static Future vibrate() => _channel.invokeMethod(
      'vibrate', {'duration': _defaultVibrationDuration.inMilliseconds});
